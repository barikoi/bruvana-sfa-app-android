        ...
        spinnerRoute!!.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                ...
                if (spinnerMarket != null) {
                    ...
                    val adapter = ArrayAdapter(
                        mContext!!,
                        android.R.layout.simple_spinner_item, marketItems
                    )
                    ...
                    if (data.has("routes") && !data.isNull("routes")){
                        ...
                        if (routesArray.length() > 0){
                            ...
                            for(i in 0 until routesArray.length()){
                                ...
                                marketNameList!!.add(Pair(routeObj.getString("id"),
                                    Pair(
                                ...
                                marketList.add(routeObj.getString("market_name"))
                            }
                            ...
                            if (outletsArray.length()>0){
                                ...
                                for (i in 0 until outletsArray.length()){
                                    ...
                                    val shops = Shops(
                                        ...
                                        outletObj.getString("market_id"),
                                        outletObj.getString("market_name"),
